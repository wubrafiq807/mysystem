...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/Exam Group.css" type="text/css">
    </head>
    <body>
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-2"><a id="link_gst">Connect Exam</a></div>
                <div class="col-md-1"><a id="link_gst">New</a></div>
            </div>
            <form>
