...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/Student_settings.css" type="text/css">
    ...
    <body>
        <div class="container">
            ...
            <div class="row icon">
                <div class="col-xs-12 ">
                    <img src="course_1.jpg" height="120" width="100" align="left">
                    <a href="Icon.html" id="back_icon"><img src="back_1.jpg" height="80" width="150" ></a>
                ...
                <div class="col-xs-10">
                    <form id="First_form">
                        <table>
                            ...
                            <tr>
                                <td></td>
                                <td><input type="text" name=""><img src="Delete.png" width="20" height="20"></td>
